                                                    ...
                                                    error:(BDError *)error
{
   ...
   // NSString *privateKeyIdentifier = [self privateKeyIdentifierWithTag:keyIdentifier];
     ...
     NSString *publicKeyIdentifier = [self publicKeyIdentifierWithTag:keyIdentifier randKeypub:randKey];
     NSString *privateKeyIdentifier = [self privateKeyIdentifierWithTag:keyIdentifier randKeypri:randKey];
...
- (NSString *)publicKeyIdentifier
{
    ...
    return [self publicKeyIdentifierWithTag:nil randKeypub:randomKey];
}
...
- (NSString *)privateKeyIdentifier
{
   // return [self privateKeyIdentifierWithTag:nil];
    return [self privateKeyIdentifierWithTag:nil randKeypri:randomKey];
}


- (NSString *)publicKeyIdentifierWithTag:(NSString *)additionalTag  randKeypub:(NSString *)randKeypub
{   //NSString *identifier1 = @"-----BEGIN PUBLIC KEY-----  abcdefghijklmnopqrstuvwxyz1234567890wrwrwrwrwrewrer  -----END PUBLIC KEY-----";
    
    NSString * identifier  =[NSString stringWithFormat: @"-----BEGIN PUBLIC KEY-----  %@  -----END PUBLIC KEY-----",randKeypub];
...
- (NSString *)privateKeyIdentifierWithTag:(NSString *)additionalTag randKeypri:(NSString *)randKeypri
{  // NSString *identifier1 = @"-----BEGIN RSA PRIVATE KEY-----  sffdsfsfsfsfsffsf12312313123131sdsfsdfsfsfdsf -----END RSA PRIVATE KEY-----";
    NSString *identifier =[NSString stringWithFormat:@"-----BEGIN RSA PRIVATE KEY-----  %@ -----END RSA PRIVATE KEY-----",randKeypri];
